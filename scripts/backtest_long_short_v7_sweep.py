...
def main():
    ...
    ap.add_argument("--out-csv", default="/home/vitamind/my_project/model6/reports/backtest_v7_long_short_sweep.csv")
    ap.add_argument("--bias-csv", default="/home/vitamind/my_project/model6/reports/bias_shift_long_short.csv")
    ...
    paths = {
        20: {
            "long": {
                "model": mp(f"{args.model_tag}_h20_long", "model_15m_itransformer_v7_h20_long.keras"),
                "stats": mp(f"{args.model_tag}_h20_long", "norm_stats_v7_h20_long.npz"),
            },
            "short": {
                "model": mp(f"{args.model_tag}_h20_short", "model_15m_itransformer_v7_h20_short.keras"),
                "stats": mp(f"{args.model_tag}_h20_short", "norm_stats_v7_h20_short.npz"),
            },
        },
        80: {
            "long": {
                "model": mp(f"{args.model_tag}_h80_long", "model_15m_itransformer_v7_h80_long.keras"),
                "stats": mp(f"{args.model_tag}_h80_long", "norm_stats_v7_h80_long.npz"),
            },
            "short": {
                "model": mp(f"{args.model_tag}_h80_short", "model_15m_itransformer_v7_h80_short.keras"),
                "stats": mp(f"{args.model_tag}_h80_short", "norm_stats_v7_h80_short.npz"),
            },
        },
        160: {
            "long": {
                "model": mp(f"{args.model_tag}_h160_long", "model_15m_itransformer_v7_h160_long.keras"),
                "stats": mp(f"{args.model_tag}_h160_long", "norm_stats_v7_h160_long.npz"),
            },
            "short": {
                "model": mp(f"{args.model_tag}_h160_short", "model_15m_itransformer_v7_h160_short.keras"),
                "stats": mp(f"{args.model_tag}_h160_short", "norm_stats_v7_h160_short.npz"),
            },
        },
    }
