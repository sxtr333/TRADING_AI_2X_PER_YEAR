...
FEATURES="${ROOT_DIR}/data/BTCUSDT_15m_features_h20_v2_news_xlmr.parquet"
  ...
  docker run --rm \
    ...
    "${IMAGE}" bash -lc "
      ...
      python model6/train_keras.py \
        --features model6/data/BTCUSDT_15m_features_h20_v2_news_xlmr.parquet \
...
run_train 20 target_ret \
  model_15m_itransformer_price_h20_s512_news_xlmr_e12_b16.keras \
  norm_stats_15m_itransformer_price_h20_s512_news_xlmr_e12_b16.npz \
  "${ROOT_DIR}/logs/train_news_xlmr_h20.log"

run_train 80 target_ret_h80 \
  model_15m_itransformer_price_h80_s512_news_xlmr_e12_b16.keras \
  norm_stats_15m_itransformer_price_h80_s512_news_xlmr_e12_b16.npz \
  "${ROOT_DIR}/logs/train_news_xlmr_h80.log"

run_train 160 target_ret_h160 \
  model_15m_itransformer_price_h160_s512_news_xlmr_e12_b16.keras \
  norm_stats_15m_itransformer_price_h160_s512_news_xlmr_e12_b16.npz \
  "${ROOT_DIR}/logs/train_news_xlmr_h160.log"

echo "Done. Logs:"
echo "  ${ROOT_DIR}/logs/train_news_xlmr_h20.log"
echo "  ${ROOT_DIR}/logs/train_news_xlmr_h80.log"
echo "  ${ROOT_DIR}/logs/train_news_xlmr_h160.log"
